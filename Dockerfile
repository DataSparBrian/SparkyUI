...
# --allow_running_as_root: Docker RUN steps run as root by default; onnxruntime's build.sh
# guards against that (a safety check for interactive/host use) — expected and fine in an
